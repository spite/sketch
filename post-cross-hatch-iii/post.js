...
class Post {
  ...
  generateParams(gui, options = {}) {
    ...
    gui.addSlider("noiseScale", signals.noiseScale, 0, 0.1, 0.0001, (v) => (uniforms.noiseScale.value = v));
    signals.noisiness = signal(this.params.noisiness);
    gui.addSlider("noisiness", signals.noisiness, 0, 1, 0.01, (v) => (uniforms.noisiness.value = v));
