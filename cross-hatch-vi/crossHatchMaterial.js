...
function generateParams(gui, material) {
  ...
  gui.addSlider("scale", signal(params.scale), 10, 100, 0.1, (v) => (material.uniforms.scale.value = v));
  gui.addSlider("width", signal(params.width), 0, 10, 0.01, (v) => (material.uniforms.width.value = v));
}
