...
let formats = {};
formats[AlphaFormat] = "THREE.AlphaFormat";
formats[RGBFormat] = "THREE.RGBFormat";
formats[RGBAFormat] = "THREE.RGBAFormat";
formats[LuminanceFormat] = "THREE.LuminanceFormat";
formats[LuminanceAlphaFormat] = "THREE.LuminanceAlphaFormat";
//formats[ THREE.RGBEFormat ] = 'THREE.RGBEFormat';

let types = {};
types[UnsignedByteType] = "THREE.UnsignedByteType";
types[ByteType] = "THREE.ByteType";
types[ShortType] = "THREE.ShortType";
types[UnsignedShortType] = "THREE.UnsignedShortType";
types[IntType] = "THREE.IntType";
types[UnsignedIntType] = "THREE.UnsignedIntType";
types[FloatType] = "THREE.FloatType";
types[HalfFloatType] = "THREE.HalfFloatType";
types[UnsignedShort4444Type] = "THREE.UnsignedShort4444Type";
types[UnsignedShort5551Type] = "THREE.UnsignedShort5551Type";
types[UnsignedShort565Type] = "THREE.UnsignedShort565Type";
...
class FBOHelper {
  constructor(renderer) {
    ...
    this.grid.setAttribute(
      "style",
      "position: fixed; left: 50%; top: 50%; border: 1px solid #000000; transform: translate3d(-50%, -50%, 0 ); box-shadow: 0 0 50px black; display: none"
    );
  ...
  attach(fbo, name, formatter) {
    ...
    const material = new MeshBasicMaterial({
      map: fbo.texture ? fbo.texture : fbo,
      side: DoubleSide,
    });
  ...
  readPixel(obj, u, v) {
    ...
    if (type === null) {
      console.warning(
        fbo.texture ? fbo.texture.type : fbo.type + " not supported"
      );
      return;
    }
